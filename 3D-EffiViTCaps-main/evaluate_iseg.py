...
if __name__ == "__main__":
    ...
    val_parser.add_argument("--output_dir", type=str, default=" ", help="output_dir path")
    ...
    val_parser.add_argument("--axis", type=str, default="all", help="z/y/x or all")
    ...
    if args.checkpoint_path != "":
        if args.model_name == "ucaps":
            ...
            net = ConvCaps3D.load_from_checkpoint(
                args.checkpoint_path,
                val_patch_size=args.val_patch_size,
                sw_batch_size=args.sw_batch_size,
                overlap=args.overlap,
